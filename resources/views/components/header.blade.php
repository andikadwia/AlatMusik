                ...
                @auth
                    ...
                    <div class="relative group">
                        ...
                        <div id="user-dropdown" class="absolute hidden right-0 mt-2 w-56 bg-white border border-gray-200 rounded-md shadow-lg z-50 divide-y divide-gray-100">
                            ...
                            <!-- Menu items -->
                            <div class="py-1">
                                <a href="/profil" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-colors duration-150">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    Profil Saya
                                </a>
                                <a href="/pesanan" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-colors duration-150">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="fixed inset-y-0 right-0 w-full max-w-xs bg-white shadow-xl transform transition-transform duration-200 ease-in-out">
            ...
            <div class="px-2 py-2 overflow-y-auto h-[calc(100vh-3.5rem)]">
                ...
                <div class="mt-2 pt-2 border-t border-gray-200">
                    @auth
                        <a href="/profil" class="block px-3 py-2.5 text-base text-gray-700 hover:text-primary hover:bg-gray-50 rounded-md flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            Profil Saya
                        </a>
                        <a href="/pesanan" class="block px-3 py-2.5 text-base text-gray-700 hover:text-primary hover:bg-gray-50 rounded-md flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                            </svg>
                            Pesanan Saya
