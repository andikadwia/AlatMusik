...
    </div>
    ...
    <div class="p-4">
        ...
        <!-- Rating with star hover effects and half-star support -->
<div class="flex items-center mb-3">
    <div class="flex items-center mr-1">
        @php
            ...
            $isEmptyHalfStar = ($rating - $fullStars) > 0.7;
        @endphp
        ...
        @for ($i = 1; $i <= 5; $i++)
            ...
            @elseif ($i == $fullStars + 1 && $hasHalfStar)
                ...
                <div class="relative w-4 h-4">
                    ...
                    <svg class="absolute top-0 left-0 w-4 h-4 text-amber-400 hover:text-amber-500 transition-colors duration-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" style="clip-path: inset(0 50% 0 0)">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                    </svg>
                </div>
            @else
