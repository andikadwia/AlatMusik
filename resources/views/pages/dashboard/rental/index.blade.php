                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-[#a08963]">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">Pemesan</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-200 uppercase tracking-wider">Tanggal Sewa</th>
