...
<section id="ulasan" class="py-12 sm:py-16 bg-gradient-to-b from-gray-100 to-gray-100">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4" data-aos="fade-up" data-aos-delay="300">Mengapa Memilih Kami?</h2>
            <p class="text-lg text-gray-600 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="300">Kami menawarkan pengalaman penyewaan alat musik yang mudah dan terpercaya</p>
        </div>
        ...
        @else
            <div class="text-center py-12 bg-white rounded-lg shadow-sm max-w-2xl mx-auto" data-aos="fade-up">
